 ...
 */
class ValueListenableFunc extends StatelessWidget {
  const ValueListenableFunc({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: ValueListenableBuilder<int>(
          ...
          //child 会作为builder的第三个参数传递给 builder，通过这种方式就可以实现组件缓存，原理和AnimatedBuilder 第三个 child 相同
