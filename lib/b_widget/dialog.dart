...
''';
    ui = const SimpleDialogRoute();
  }
}
class Demo3 extends Data{
  @override
  void init() {
    title="ListViewDialog";
    code = '''
...
''';
    ui = const CustomDialogRoute();
  }
}
class Demo5 extends Data{
  @override
  void init() {
    title="DialogStateManage";
    code = '''
...
''';
    ui = const DialogStateManageRoute();
  }
}
...
''';
    ui = const BottomSheetDialogRoute();
  }
}
...
''';
    ui = const LoadingDialogRoute();
  }
}
class Demo8 extends Data{
  @override
  void init() {
    title="LoadingWidthDialog";
    code = '''
...
''';
    ui = const LoadingWidthDialogRoute();
  }
}
...
''';
    ui = const DatePickerDialogRoute();
  }
}
class Demo10 extends Data{
  @override
  void init() {
    title="IOSDatePickerDialog";
    code = '''
//IOS风格日历框
...
''';
    ui = const IOSDatePickerDialogRoute();
  }
}



class DialogWidget extends Datas {
  @override
  void init() {
    title = "Dialog";
    list.add(Demo1()..init());
