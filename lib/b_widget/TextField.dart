...
class TextFieldWidget extends Datas {
  @override
  void init() {
    title = "TextField";
    list.add(TextField1()..init());
    list.add(TextField2()..init());
    list.add(TextField3()..init());
    list.add(TextField4()..init());
    list.add(TextField5()..init());
    list.add(TextField6()..init());
  }
}